...
func (r *queryResolver) GetScheduledWorkflowsRunDetails(ctx context.Context, scheduleIds []string) ([]*model.ScheduledWorkflowsRunDetails, error) {
	return queries.QueryScheduledWorkflowsRunDetails(scheduleIds)
}
